...
freq_span_range:dict = {"q0":[-4e6,+5e6],"q1":[-4e6,+5e6],"q2":[-4e6,+5e6],"q3":[-4e6,+5e6]}#, "q1":[-5e6,5e6]}    # np.linspace(rof+span, rof+span, freq_pts)
flux_range:list = [-0.4, 0.4, 40]                                 # flux [from, end, pts/step]
