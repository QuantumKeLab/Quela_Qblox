...
# T1 settings
QM.T1_time_range = {"q0":[0,400e-6],"q2":[0,400e-6]}#,"q1":[0,50e-6]# skip if empty.
# T2 settings
QM.T2_time_range = {"q0":[0,150e-6],"q2":[0,200e-6]}#,"q1":[0,50e-6]} # skip if empty.
QM.echo_pi_num = 0                                # int, if 0 ramsey, 1 spin echo, more for CPMG. All qubit in T2_time_range share a same number.
QM.a_little_detune_Hz = 0.1e6                     # for all qubit in T2_time_range. Set None if you do SpinEcho or CPMG
# SingleShot settings, skip if 0 shot
QM.OS_shots = 20000     
QM.OS_target_qs = ["q0","q2"]#,"q1"]
