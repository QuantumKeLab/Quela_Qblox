...
freq_range:dict = {"q2":[2.9e9, 3.3e9]}#, "q1":[4.05e9,4.25e9]}    # [freq_start, freq_end] use linspace, or [0] system calculate fq for you.
xyl_range:list = [0,0.6,10]                                 # driving power [from, end, pts/step]
