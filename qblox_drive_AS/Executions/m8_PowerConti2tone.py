...
freq_range:dict = {"q0":[3.34e9,3.74e9]} # "q1":[4.05e9,4.25e9]   # [freq_start, freq_end] use linspace, or [0] system calculate fq for you.
xyl_range:list = [0.2]                                 # driving power [from, end, pts/step]
