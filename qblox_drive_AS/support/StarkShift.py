...
def plot_ROopti(Qmanager, nc_path,dress_e,dress_g):
    ...
    for q in ds.data_vars:
        ...
        amp = -np.sqrt(i_data**2 + q_data**2).transpose()
        ...
        """Fitting and plot"""
        # 线性拟合
        popt, pcov = curve_fit(linear_fit, max_ro_power[:-20], max_freqs[:-20],p0=(-3e9,4e9))
        a, b = popt
        print(popt)
...
if __name__ == "__main__":
    ...
    QD_agent.QD_loader()
    file = r"C:\Users\Ke Lab\Downloads\DRKEq0StarkshiftH19M23S42.nc"
    dress_g=5.85023
    dress_e=5.84954
