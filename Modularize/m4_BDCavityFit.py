...
def preciseCavity_executor(QD_agent:QDmanager,meas_ctrl:MeasurementControl,ro_elements:dict,run:bool=True, ro_amps:dict={})->dict:
    ...
    if run:
        cs_ds = Cavity_spec(QD_agent,meas_ctrl,ro_elements,run=True,ro_amps=ro_amps,n_avg=600)
...
if __name__ == "__main__":
    ...
    ro_element = {
        #5Q array
        "q0":{  "bare" :{"ro_amp":0.25,"window_shift":0e6},
                "dress":{"ro_amp":0.1,"window_shift":0.6e6}},        
        "q1":{  "bare" :{"ro_amp":0.2,"window_shift":0e6},
                "dress":{"ro_amp":0.1,"window_shift":0.55e6}},
        ...
        #WJV7
        # "q0":{  "bare" :{"ro_amp":0.1,"window_shift":0e6},
        #         "dress":{"ro_amp":0.05,"window_shift":0.2e6}},        
        # "q1":{  "bare" :{"ro_amp":0.1,"window_shift":0e6},
        #         "dress":{"ro_amp":0.1,"window_shift":0.8e6}},
        # "q2":{  "bare" :{"ro_amp":0.15,"window_shift":0e6},
        #         "dress":{"ro_amp":0.15,"window_shift":0.6e6}},                
        # "q3":{  "bare" :{"ro_amp":0.15,"window_shift":0e6},
        #         "dress":{"ro_amp":0.1,"window_shift":0.7e6}},
    }
    ro_attes = {"dress":32, "bare":24} # all ro_elements shared
