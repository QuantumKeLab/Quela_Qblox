...
def plot_ROopti(Qmanager, nc_path):
    ...
    for q in ds.data_vars:
        ...
        ax2.set_ylim(0, delta_freqs[-1] * 1e-6)  # 转为 MHz
...
if __name__ == "__main__":
    ...
    QD_agent.QD_loader()
    file = r"C:\Users\Ke Lab\Documents\GitHub\Quela_Qblox\Modularize\Meas_raw\2024_12_5\DRKEq0StarkshiftH5M29S16.nc"
